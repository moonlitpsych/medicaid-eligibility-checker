...
function calculatePatientResponsibility(eligibilityData, cptCode) {
    ...
    // HMHI-BHN is UUHP's carved-out behavioral health network with standard $25 copay
    const isHMHIBHN = detectHMHIBHN(eligibilityData);
    if (isHMHIBHN && !copay) {
        copay = 25; // Standard HMHI-BHN copay for psychiatric visits
        console.log('✅ HMHI-BHN detected: Applying $25 copay for behavioral health visits');
    }
